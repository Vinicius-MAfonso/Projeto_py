...
sorteado = Label(root, text=words[word], font="arial 20", bg="#90e0ef")
...
# Pontuação
lb_box_pontuacao = Label(root, bg="#0096c7", width=14, height=5)
lb_box_pontuacao.place(x=15, y=95)
lb_score_title = Label(root, text="Pontuação", font="times 15", fg="white", bg="#0096c7")
lb_score_title.place(x=25, y=100)
lb_score = Label(root, text="200", font="times 15", fg="yellow", bg="#0096c7")
